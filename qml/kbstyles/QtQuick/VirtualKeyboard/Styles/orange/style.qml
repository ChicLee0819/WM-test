...
KeyboardStyle {
    ...
    readonly property string normalKeyBGColor: "#ffba75"
    readonly property string functionKeyBGColor: "#7a5937"
    readonly property string languageKeyBGColor: "#804000"
